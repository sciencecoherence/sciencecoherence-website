...
<body>
  <main class="gateway">
    ...
    <p class="intro">This adds three Writing Room tables beside the blog tables. It reuses the existing administrator account and does not alter the blog’s users.</p>
