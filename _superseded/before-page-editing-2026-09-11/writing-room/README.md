...
- **Section**: where it lives on the site, such as Research, The Lab or Transmissions (`sections.js`). Sections are edited by hand.
...
- Collections: `C:\cohera\science-coherence-website\collections.js`. Sections (`sections.js`) are read, never written.
