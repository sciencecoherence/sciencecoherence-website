...
(() => {
  ...
  /* The collections are authored in collections.js (window.SC_COLLECTIONS),
     which the Writing Room can extend and rename. This copy is only the
     fallback for a page opened without that file; keep the two in step. */
